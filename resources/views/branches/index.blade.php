...
<div class="content">
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Sucursales<small></small></h3>
            <a href="{{ route('branches.create') }}" class="btn btn-sm btn-outline-primary"> Crear </a>
        </div>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">
                            <a href="javascript:void(0)">{{ optional($branch->company)->name }}</a>
                        </td>                        
                        <td class="fw-semibold">
                            <a href="javascript:void(0)">{{ optional($branch->commune)->name }}</a>
                        </td>                        
                        <td>
