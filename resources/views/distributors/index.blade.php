...
<div class="content">
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Distribuidor<small></small></h3>
            <a href="{{ route('distributors.create') }}" class="btn btn-sm btn-outline-primary"> Crear </a>
        ...
        <div class="block-content block-content-full">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">{{$distributor -> id}}</td>
                        <td class="fw-semibold">
                            <a href="javascript:void(0)">{{$distributor -> name}}</a>
                        </td>
                        <td class="text-center">{{$distributor -> address}}</td>
                        <td class="text-center">{{$distributor -> address_number}}</td>
                        <td class="text-center">{{$distributor -> phone_number}}</td>
                        ...
                        <td>
                            ...
                            <div class="d-inline-flex">
                                ...
                                <form action="{{ route('distributors.destroy', $distributor->id) }}" method="POST" class="formEliminar">
                                    @csrf
                                    @method('DELETE')
