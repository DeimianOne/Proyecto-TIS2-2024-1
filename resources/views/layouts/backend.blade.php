                    ...
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/roles') ? ' active' : '' }}"
                                        href="{{ url('dashboard/roles') }}">
                                        <span class="nav-main-link-name">Roles</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/companies') ? ' active' : '' }}"
                                        href="{{ url('dashboard/companies') }}">
                                        <span class="nav-main-link-name">Compañia</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/products') ? ' active' : '' }}"
                                        href="{{ url('dashboard/products') }}">
                                        <span class="nav-main-link-name">Productos</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/distributors') ? ' active' : '' }}"
                                        href="{{ url('dashboard/distributors') }}">
                                        <span class="nav-main-link-name">Distribuidor</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/branches') ? ' active' : '' }}"
                                        href="{{ url('dashboard/branches') }}">
                                        <span class="nav-main-link-name">Sucursales</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/events') ? ' active' : '' }}"
                                        href="{{ url('dashboard/events') }}">
                                        <span class="nav-main-link-name">Eventos</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/companyevents') ? ' active' : '' }}"
                                        href="{{ url('dashboard/companyevents') }}">
                                        <span class="nav-main-link-name">Evento Compañia</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/companydistributors') ? ' active' : '' }}"
                                        href="{{ url('dashboard/companydistributors') }}">
                                        <span class="nav-main-link-name">Compañia distribuidor</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/beers') ? ' active' : '' }}"
                                        href="{{ url('dashboard/beers') }}">
                                        <span class="nav-main-link-name">Cerveza</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/beerstyles') ? ' active' : '' }}"
                                        href="{{ url('dashboard/beerstyles') }}">
                                        <span class="nav-main-link-name">Estilo cerveza</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/producttypes') ? ' active' : '' }}"
                                        href="{{ url('dashboard/producttypes') }}">
                                        <span class="nav-main-link-name">Tipo de producto</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/beerformats') ? ' active' : '' }}"
                                        href="{{ url('dashboard/beerformats') }}">
                                        <span class="nav-main-link-name">Formato</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/regions') ? ' active' : '' }}"
                                        href="{{ url('dashboard/regions') }}">
                                        <span class="nav-main-link-name">Región</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/provinces') ? ' active' : '' }}"
                                        href="{{ url('dashboard/provinces') }}">
                                        <span class="nav-main-link-name">Provincia</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/communes') ? ' active' : '' }}"
                                        href="{{ url('dashboard/communes') }}">
                        ...
                        <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="true" href="#">
                                <i class="nav-main-link-icon fa-solid fa-user-pen"></i>
                                <span class="nav-main-link-name">Edición página</span>
                            </a>
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('dashboard/ldgfooters') ? ' active' : '' }}"
                                        href="{{ url('dashboard/ldgfooters') }}">
                                        <span class="nav-main-link-name">Edición footer</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
