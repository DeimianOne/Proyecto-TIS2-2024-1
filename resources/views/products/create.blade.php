    ...
    <div class="block-content block-content-full d-flex justify-content-center">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="beer-fields mb-2 form-group" style="display: none;">
                ...
                <input type="text" class="form-control" id="beer-style" name="beer-style" placeholder="Estilo de la cerveza">
            </div>

            <div class="beer-fields mb-2 form-group" style="display: none;">
                <label class="form-label" for="beer-format">Formato</label>
                <input type="text" class="form-control" id="beer-format" name="beer-format" placeholder="Formato de la cerveza">
            </div>
