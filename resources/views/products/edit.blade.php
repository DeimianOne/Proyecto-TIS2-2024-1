                    ...
                    <div class="beer-fields mb-2 form-group">
                        ...
                        <select class="form-control" id="beer-style" name="beer-style">
                            @foreach($beerstyles as $beerstyle)
                                <option value="{{ $beerstyle->id }}" {{ $beerstyle->id == $product->beer->beerstyle_id ? 'selected' : '' }}>{{ $beerstyle->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="beer-fields mb-2 form-group">
                        ...
                        <select class="form-control" id="beer-format" name="beer-format">
                            @foreach($beerformats as $beerformat)
                                <option value="{{ $beerformat->id }}" {{ $product->beer->beerformats->contains($beerformat->id) ? 'selected' : '' }}>{{ $beerformat->container }}</option>
                            @endforeach
                        </select>
                    </div>
                @endif
