...
@section('content')
  ...
  <div class="content">
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Productos<small></small></h3>
        <a href="{{ route('products.create') }}" class="btn btn-sm btn-outline-primary"> Crear Nuevo +</a><!-- destina a el crear nuevo producto -->
      </div>
          ...
          <tbody>
            @foreach ($products as $product)
              <tr>
                ...
                <td>
                  <a>{{$product -> visualizations}}</a>
                </td>
                <td>
                  <a>{{$product -> visibility}}</a>
                </td>
