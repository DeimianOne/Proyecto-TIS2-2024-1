...
<div class="content">
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Región<small></small></h3>
            <a href="{{ route('regions.create') }}" class="btn btn-sm btn-outline-primary"> Crear </a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="d-inline-flex">
                                ...
                                <form action="{{ route('regions.destroy', $region->id) }}" method="POST" class="formEliminar">
                                    @csrf
                                    @method('DELETE')
